...
export function getCategoryName(id) {
  switch (id) {
    ...
    case 16:
      return 'Mathematics'
    case 17:
      return 'MadicineAndPublicHealth'
    case 18:
      return 'MaterialsScience'
    case 19:
      return 'Philosophy'
...
export function categoryText(category, vue) {
  switch (category) {
    case 1:
      return vue.$t('category.computerScirnce')
    case 2:
    ...
    case 6:
      return vue.$t('category.enviroment')
    case 7:
    ...
    case 13:
      return vue.$t('category.busineesandManagement')
    case 14:
      return vue.$t('category.earthScience')
    case 15:
      return vue.$t('category.materialsScience')
    case 16:
      return vue.$t('category.mathematics')
    case 17:
      return vue.$t('category.madicineAndPublicHealth')
    case 18:
      return vue.$t('category.materialsScience')
    case 19:
